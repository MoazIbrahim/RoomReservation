...
<header>
  ...
  <body>
    <div class="container d-flex flex-column min-vh-100 mt-3 ll">
      <h2 class="mb-3 title2 text-center">All Reservations</h2>
            ...
            <div class="row">
              ...
              <div class="col-md-11 xd">
                <div class="card-body">
                  <div class="row">
                    <div class="col-8">
                      <h5 class="card-title"> <?php echo "Reservation ID: " . $row['id'] . '  By: ' . $userName ?> </h5>
                      <p class="card-text">
                    ...
                    <div class="my-3 ms-auto">
                      <a href="modifyReservation.php"><button class="btn btn-info">Modify</button></a>
